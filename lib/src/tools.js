...
export const toolSpecs = [
    {
        name: "cymose_tree",
        description: "Show the Cymose session graph: what was tried, what failed, what is focused. Call this to see context.",
        inputSchema: { type: "object", properties: {} },
    },
    {
        name: "cymose_branch",
        description: "Start a new Cymose node (a short session). Children inherit ancestor summaries. Omit parent_id to fork from the focused node, or to create a root if the graph is empty.",
        inputSchema: {
            type: "object",
            properties: {
...
export const MAP_INSTRUCTIONS = "Cymose is a session map, not a coding agent. Call cymose_tree or cymose_inherit before repeating work. Persist with cymose_dump; restore with cymose_load. The graph lives in this process.";
